...
Compatibility fixes for Home Assistant 2026.x.
...
`beta-0.2.2` … `0.3.9.b*` (2025-10 … 2025-12) — iterations of the fork based on the
original integration by [@anpavlov](https://github.com/anpavlov). No changelog was kept.
